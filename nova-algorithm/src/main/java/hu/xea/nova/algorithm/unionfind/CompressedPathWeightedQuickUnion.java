 ...
 * 
 * It also compresses the depth of the tree by shortening paths.
 * 
 * @author xea
 *
 */
public class CompressedPathWeightedQuickUnion {
	 ...
	 */
	public CompressedPathWeightedQuickUnion(final int n) {
		id = new int[n];
